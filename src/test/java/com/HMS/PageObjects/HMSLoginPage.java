...
import com.framework.utilities.RandomDataMethods;
...
public class HMSLoginPage extends TestBase {
	...
	public void generateDataForHMSLogin(){
		 ...
		 username1=data.getCellData("Sheet1", "Username", 2);
		 password1=data.getCellData("Sheet1", "Password", 2);
	...
	public void fillupDataForHMSLOgin(WebDriver driver) throws IOException{
		...
		//String mobile = RandomDataMethods.generateMobileNumber();
		//String email = RandomDataMethods.generateEmail();
